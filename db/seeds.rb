...
futurama        = Fabricate(:video, title: 'Futurama', category: comedies, small_cover_url: '/tmp/futurama.jpg')
south_park      = Fabricate(:video, title: 'South Park', category: comedies, small_cover_url: '/tmp/south_park.jpg')
family_guy      = Fabricate(:video, title: 'Family Guy', category: comedies, small_cover_url: '/tmp/family_guy.jpg')
...
salem           = Fabricate(:video, title: 'Salem', category: dramas, small_cover_url: '/tmp/salem.jpg', large_cover_url: '/tmp/salem_large.jpg', description: "Set in the volatile world of 17th century Massachusetts, 'Salem' explores what really fueled the town's infamous witch trials and dares to uncover the dark, supernatural truth hiding behind the veil of this infamous period in American history. In Salem, witches are real, but they are not who or what they seem.")
penny_dreadful  = Fabricate(:video, title: 'Penny Dreadful', category: dramas, small_cover_url: '/tmp/penny_dreadful.jpg', large_cover_url: '/tmp/penny_dreadful_large.jpg', description: 'Explorer Sir Malcolm Murray, American gunslinger Ethan Chandler, and others unite to combat supernatural threats in Victorian London.')
game_of_thrones = Fabricate(:video, title: 'Game of Thrones', category: dramas, small_cover_url: '/tmp/game_of_thrones.jpg', description: 'Seven noble families fight for control of the mythical land of Westeros.')
silicon_valley  = Fabricate(:video, title: 'Silicon Valley', category: dramas, small_cover_url: '/tmp/silicon_valley.jpg', description: "In the high-tech gold rush of modern Silicon Valley, the people most qualified to succeed are the least capable of handling success. A comedy partially inspired by Mike Judge's own experiences as a Silicon Valley engineer in the late 1980s.")
mozu            = Fabricate(:video, title: 'MOZU Season1～百舌の叫ぶ夜～', category: dramas, small_cover_url: '/tmp/mozu.jpg', large_cover_url: '/tmp/mozu_large.jpg', description: 'サルドニア共和国大統領の来日の日がやってきた。
...
kanbe           = Fabricate(:video, title: '軍師官兵衛', category: dramas, small_cover_url: '/tmp/kanbe.jpg', large_cover_url: '/tmp/kanbe_large.jpg', description: '黒田官兵衛は、戦国乱世にあって一風変わった男だった。
...
arthur = Fabricate(:user, email: 'arthur@intxtion.com', full_name: 'Arthur Pai')
